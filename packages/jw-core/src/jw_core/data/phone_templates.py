...
_DEFAULT_GENERIC = LetterTemplate(
    ...
    bridge=_t(
        en="Many today wonder where to find practical guidance. The Bible verse I have in mind addresses exactly that.",
    ...
    closing=_t(
        ...
        pt="O que o senhor acha: esse pensamento combina com sua experiência?",
    ),
...
_NEW_GENERIC = LetterTemplate(
    opener=_t(
        en="Hi — I won't take much of your time. Quick Bible-based thought, would that be okay?",
        es="Hola, no le quitaré mucho tiempo. Un pensamiento bíblico breve, ¿le parece bien?",
        pt="Olá, não tomarei muito do seu tempo. Um pensamento bíblico breve, tudo bem?",
    ),
    bridge=_t(
        en="The Bible has a record of guiding lives over thousands of years. One verse can already give a fresh angle.",
        es="La Biblia tiene un historial de guiar vidas por miles de años. Un solo versículo ya puede dar otro ángulo.",
        pt="A Bíblia tem um histórico de guiar vidas por milhares de anos. Um versículo já pode dar um ângulo novo.",
    ),
    closing=_t(
...
_RELIGIOUS_GENERIC = LetterTemplate(
    opener=_t(
        en="Good day — I'm calling to share a brief Bible reflection with people of faith. Have you got a moment?",
        es="Buen día. Llamo para compartir una breve reflexión bíblica con personas de fe. ¿Tiene un momento?",
        pt="Bom dia. Estou ligando para compartilhar uma breve reflexão "
        "bíblica com pessoas de fé. O senhor tem um momento?",
    ),
    bridge=_t(
        en="Even familiar passages reveal new layers on careful reading. The thought I'd share takes thirty seconds.",
        es="Incluso pasajes familiares revelan capas nuevas al releerlos. "
        "El pensamiento que quiero compartir toma medio minuto.",
        pt="Mesmo passagens conhecidas revelam camadas novas ao serem relidas. O pensamento leva meio minuto.",
    ),
    closing=_t(
...
_ATHEIST_GENERIC = LetterTemplate(
    opener=_t(
        ...
        es="Hola, no vendo nada. Solo un pensamiento bíblico de un minuto, sin presuponer sus creencias. ¿Le parece?",
        pt="Olá, não estou vendendo nada. Só um pensamento bíblico de um minuto, sem supor suas crenças. Tudo bem?",
    ),
    bridge=_t(
        en="If a designer exists, evidence should be findable. Romans 1:20 makes that exact claim — open to scrutiny.",
        es="Si existe un diseñador, debería haber evidencia. Romanos 1:20 afirma justamente eso — abierto al examen.",
        pt="Se existe um designer, deveria haver evidência. Romanos 1:20 afirma exatamente isso — aberto ao exame.",
    ),
    closing=_t(
...
_GRIEVING_GENERIC = LetterTemplate(
    opener=_t(
        en="Hi — I'll be brief. I have one Bible thought that's brought comfort to many in grief. May I share it?",
        es="Hola, seré breve. Tengo un pensamiento bíblico que ha consolado a muchos en el duelo. ¿Puedo compartirlo?",
        pt="Olá, serei breve. Tenho um pensamento bíblico que tem consolado muitos no luto. Posso compartilhar?",
    ),
    bridge=_t(
        en="Loss doesn't have to be the final word. The verse I'm thinking of speaks gently and concretely.",
        es="La pérdida no tiene por qué ser la última palabra. El "
        "versículo en el que pienso habla con ternura y de modo "
        "concreto.",
        pt="A perda não precisa ser a última palavra. O versículo no qual penso fala com ternura e de modo concreto.",
    ),
    closing=_t(
...
_YOUNG_GENERIC = LetterTemplate(
    opener=_t(
        ...
        es="Hola, llamada breve, un pensamiento bíblico, menos de un minuto. ¿Te parece?",
        pt="Oi, ligação rápida, um pensamento bíblico, menos de um minuto. Tudo bem?",
    ),
    bridge=_t(
        en="A lot hits at once when you're young — identity, future, what counts. Bible has practical takes.",
...
_PARENTS_GENERIC = LetterTemplate(
    opener=_t(
        en="Hi — I'm a parent too. One short Bible thought on raising kids today, may I share it?",
        es="Hola, también tengo responsabilidades de crianza. Un "
        "pensamiento bíblico breve sobre criar hoy, ¿se lo comparto?",
        pt="Olá, também crio filhos. Um pensamento bíblico breve sobre criação hoje, posso compartilhar?",
    ),
    bridge=_t(
        en="The Bible's family advice is surprisingly practical. One verse holds up under everyday pressure.",
