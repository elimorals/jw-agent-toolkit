...
ORATORY_POINTS: tuple[OratoryPoint, ...] = (
    _p(
        1,
        en=("Choice of words", "Use words your audience understands; avoid jargon and undefined terms."),
        es=("Elección de palabras", "Use palabras que su audiencia entienda; evite jerga y términos sin definir."),
        pt=("Escolha das palavras", "Use palavras que sua audiência entenda; evite jargão e termos não definidos."),
        category="content",
    ),
    _p(
        2,
        en=("Pronunciation", "Pronounce each word clearly so listeners need not strain to follow."),
        es=("Pronunciación", "Pronuncie cada palabra con claridad para que los oyentes no se esfuercen."),
        pt=("Pronúncia", "Pronuncie cada palavra claramente para que ouvintes não se esforcem."),
        category="delivery",
        applies_to=("bible_reading", "return_visit", "bible_study"),
    ),
    _p(
        3,
        en=("Fluency", "Avoid hesitations and filler words; speak in complete thought units."),
        es=("Fluidez", "Evite vacilaciones y muletillas; hable en unidades de pensamiento completas."),
        pt=("Fluência", "Evite hesitações e palavras de preenchimento; fale em unidades completas."),
        category="delivery",
    ),
    _p(
        4,
        en=("Pausing", "Pause before and after key thoughts to let them sink in."),
        es=("Pausas", "Haga pausas antes y después de las ideas clave para que se asienten."),
        pt=("Pausas", "Faça pausas antes e depois das ideias-chave para que sejam absorvidas."),
        category="delivery",
    ),
    _p(
        5,
        en=("Sense stress", "Stress the words that carry the main thought of the sentence."),
        es=("Énfasis correcto", "Acentúe las palabras que llevan la idea principal de la oración."),
        pt=("Ênfase correta", "Acentue as palavras que carregam a ideia principal da frase."),
        category="delivery",
        applies_to=("bible_reading", "return_visit", "bible_study"),
    ),
    _p(
        6,
        en=("Modulation", "Vary pitch, pace, and volume to keep the audience engaged."),
        es=("Modulación", "Varíe el tono, el ritmo y el volumen para mantener la atención."),
        pt=("Modulação", "Varie tom, ritmo e volume para manter o interesse."),
        category="delivery",
    ),
    _p(
        7,
        en=("Enthusiasm", "Speak with warmth and conviction; show you believe what you say."),
        es=("Entusiasmo", "Hable con calidez y convicción; demuestre que cree lo que dice."),
        pt=("Entusiasmo", "Fale com calor e convicção; mostre que acredita no que diz."),
        category="delivery",
    ),
    _p(
        8,
        en=("Feeling", "Reflect the emotion suited to the content — joy, urgency, comfort."),
        es=("Sentimiento", "Refleje la emoción adecuada al contenido: gozo, urgencia, consuelo."),
        pt=("Sentimento", "Reflita a emoção adequada ao conteúdo — alegria, urgência, conforto."),
        category="delivery",
    ),
    _p(
        9,
        en=("Gestures", "Use natural gestures that match the words."),
    ...
    _p(
        10,
        en=("Eye contact", "Look at individuals, not over their heads."),
    ...
    _p(
        11,
        en=("Posture", "Stand or sit upright; project openness and confidence."),
    ...
    _p(
        12,
        en=("Appropriate appearance", "Dress in a way that does not distract from your message."),
    ...
    _p(
        13,
        en=("Opening words", "Catch interest in the first sentences; raise a question or need."),
    ...
    _p(
        14,
        en=("Concluding words", "End by recapping the main point and inviting a next step."),
    ...
    _p(
        15,
        en=("Logical development", "Order points so each one prepares the next."),
    ...
    _p(
        16,
        en=("Main points stand out", "Make sure the audience can identify the few main points."),
        es=(
            "Puntos principales bien definidos",
            "Asegúrese de que la audiencia identifique los pocos puntos principales.",
        ),
    ...
    _p(
        17,
        en=("Repetition for emphasis", "Restate key thoughts in slightly different words."),
    ...
    _p(
        18,
        en=("Effective questions", "Use questions that invite reflection, not just yes/no answers."),
    ...
    _p(
        19,
        en=("Illustrations that teach", "Pick illustrations the audience can relate to."),
    ...
    _p(
        20,
        en=("Practical value", "Show how the material helps daily life."),
    ...
    _p(
        21,
        en=("Convincing argument", "Build a reasoned case, not bare assertion."),
    ...
    _p(
        22,
        en=("Accurate information", "Cite facts and scriptures correctly; verify before speaking."),
    ...
    _p(
        23,
        en=("Use of the Bible", "Make Scripture the centerpiece, not a footnote."),
    ...
    _p(
        24,
        en=("Introducing scriptures", "Set up each verse so the listener knows why it matters."),
    ...
    _p(
        25,
        en=("Reading scriptures with feeling", "Read the verse so its emotion comes through."),
    ...
    _p(
        26,
        en=("Applying the scripture", "Connect the verse to the listener's situation."),
    ...
    _p(
        27,
        en=("Reasoning with audience", "Engage in a dialogue, not a monologue."),
    ...
    _p(
        28,
        en=("Tact", "Express truth without abrasiveness or condescension."),
    ...
    _p(
        29,
        en=("Empathy", "Acknowledge feelings before correcting ideas."),
    ...
    _p(
        30,
        en=("Sincere interest", "Listen actively; respond to what the person actually said."),
    ...
    _p(
        31,
        en=("Common ground", "Find a point of agreement before introducing differences."),
    ...
    _p(
        32,
        en=("Stirring motivation", "Help the listener want to act on what was discussed."),
    ...
    _p(
        33,
        en=("Adapting to audience", "Adjust depth and vocabulary to your listener."),
    ...
    _p(
        34,
        en=("Effective transitions", "Move smoothly from one point to the next."),
    ...
    _p(
        35,
        en=("Direct address", "Speak TO the audience, not ABOUT a topic."),
    ...
    _p(
        36,
        en=("Genuine warmth", "Smile naturally; let your concern be visible."),
    ...
    _p(
        37,
        en=("Respect for views", "Acknowledge the value the listener sees in their position."),
    ...
    _p(
        38,
        en=("Avoiding contention", "Defuse, don't escalate, when disagreement arises."),
    ...
    _p(
        39,
        en=("Constructive feedback", "Praise specific strengths; tie suggestions to one point."),
    ...
    _p(
        40,
        en=("Personal preparation", "Allot enough study time; rehearse aloud at least once."),
    ...
    _p(
        41,
        en=("Goal of the part", "Be clear in advance what you want the listener to take away."),
    ...
    _p(
        42,
        en=("Use of notes", "Use brief, glanceable notes — not a manuscript."),
    ...
    _p(
        43,
        en=("Visual aids", "Choose visuals (videos, brochures) that reinforce the point."),
    ...
    _p(
        44,
        en=("Confidence in the message", "Speak as one who knows the message is true."),
    ...
    _p(
        45,
        en=("Spiritual heart", "Let your love for Jehovah show; pray about your preparation."),
    ...
    _p(
        46,
        en=("Personal observations", "Add brief, modest personal experience when it illustrates."),
    ...
    _p(
        47,
        en=("Naturalness in delivery", "Sound like yourself, not a reciter."),
    ...
    _p(
        48,
        en=("Conviction", "Phrase statements so the listener senses certainty, not opinion."),
    ...
    _p(
        49,
        en=("Building faith in God's word", "Direct attention back to Scripture as the source."),
    ...
    _p(
        50,
        en=("Building up the listener", "End by leaving the listener encouraged, not lectured."),
