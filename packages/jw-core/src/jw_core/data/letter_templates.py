...
_GRIEVING_SUFFERING = LetterTemplate(
    opener=_t(
        ...
        es="Hola: La pérdida de un ser querido y el duelo lo cambian "
           "todo. Le escribo con cariño y sin presión.",
        pt="Olá: A perda de alguém que amamos e o luto mudam tudo. "
           "Escrevo com carinho e sem pressão.",
    ),
    bridge=_t(
