...
TERMINOLOGY_SETS: dict[str, set[str]] = {
    "es": {
        "jehová", "reino", "publicador", "anciano", "atalaya",
        "testificación", "predicación", "soberanía", "ungidos",
        "salón del reino", "estudio bíblico", "memorial",
        "asamblea", "betel", "ministerio", "espíritu santo",
        "siglo i", "principio", "celosos", "edificantes",
    },
    "en": {
        "jehovah", "kingdom", "publisher", "elder", "watchtower",
        "witnessing", "preaching", "sovereignty", "anointed",
        "kingdom hall", "bible study", "memorial",
        "assembly", "bethel", "ministry", "holy spirit",
        "first century", "principle", "zealous", "upbuilding",
    },
    "pt": {
        "jeová", "reino", "publicador", "ancião", "atalaia",
        "testemunho", "pregação", "soberania", "ungidos",
        "salão do reino", "estudo bíblico", "celebração",
        "assembleia", "betel", "ministério", "espírito santo",
    },
    "fr": {
        "jéhovah", "royaume", "proclamateur", "ancien", "tour de garde",
        "prédication", "souveraineté", "oints", "salle du royaume",
        "étude biblique", "mémorial", "assemblée", "béthel", "ministère",
        "esprit saint",
    },
    "de": {
        "jehova", "königreich", "verkündiger", "ältester", "wachtturm",
        "verkündigung", "souveränität", "gesalbte", "königreichssaal",
        "bibelstudium", "gedenkmahl", "kongress", "bethel", "dienst",
        "heiliger geist",
    },
    "it": {
        "geova", "regno", "proclamatore", "anziano", "torre di guardia",
        "predicazione", "sovranità", "unti", "sala del regno",
        "studio biblico", "commemorazione", "assemblea", "betel",
        "ministero", "spirito santo",
    },
    "ru": {
        "иегова", "царство", "возвещатель", "старейшина", "сторожевая башня",
        "проповедь", "помазанник", "помазанные", "зал царства",
        "изучение библии", "вечеря", "конгресс", "вефиль", "служение",
        "святой дух",
    },
    "ja": {
        "エホバ", "王国", "伝道者", "長老", "ものみの塔",
...
def score_terminology_proportional(
    ...
    *,
    ...
    for a in answers_list:
        low = a.lower()
        unique_hits = sum(
            1 for t in use_terms if re.search(rf"\b{re.escape(t)}\b", low)
        )
